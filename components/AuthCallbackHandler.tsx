      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80">
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full mx-4 space-y-4">
          ...
          <p className="text-slate-600 text-sm">
            Request a new link below and open it in the <strong>same browser</strong> where you requested it.
          </p>
          <div className="flex flex-col gap-2">
            ...
            <a href="/" className="w-full text-center py-2 text-sm font-medium text-primary hover:underline">
              Back to sign in
            </a>
          </div>
        </div>
