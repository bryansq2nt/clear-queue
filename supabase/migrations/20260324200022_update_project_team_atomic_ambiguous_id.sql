-- Fix: RETURNS TABLE (id, name, description, allowed_modules) creates PL/pgSQL
-- variables with those names. UPDATE ... WHERE id = p_team_id then errors with
-- 42702 "column reference id is ambiguous" (variable vs column).
