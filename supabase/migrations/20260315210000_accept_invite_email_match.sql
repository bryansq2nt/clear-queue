-- ============================================================
-- Migration: Enforce email match on invite accept
--
-- Only the person whose email is on the invite can accept it.
-- If someone else opens the link (e.g. invite forwarded), they can see
-- the invite details but accepting will fail with invite_email_mismatch.
-- ============================================================
