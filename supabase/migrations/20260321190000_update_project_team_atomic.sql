-- =============================================================================
-- Atomic sub-team update
--
-- 1) Restrict sub-team definition edits (name/description/modules) to
--    project_owner / project_manager.
-- 2) Propagate updated allowed_modules to existing team members/managers so
--    visible module tabs stay aligned with the sub-team configuration.
-- =============================================================================
