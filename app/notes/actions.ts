...
export async function getNotes(options?: { projectId?: string }): Promise<Note[]> {
...
export async function updateNote(
  ...
  if (params.project_id !== undefined) updates.project_id = params.project_id.trim() || undefined
...
export async function deleteNoteLink(linkId: string): Promise<{ error?: string }> {
  await requireAuth()
  const supabase = await createClient()
