...
export default function ContextTeamClient({
  ...
  }, [inviteEmail, inviteRoleId, projectId, baseUrl, onRefresh, t]);
        ...
        <div className="rounded-lg border border-border bg-card p-4 space-y-3">
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            ...
            >
              ...
              {inviteSaving ? t('common.loading') : t('teams.generate_link')}
            </button>
          </div>
        </div>
      )}
          ...
          <ul className="space-y-2">
            {invites.map((inv) => (
              ...
              >
                ...
                <span
                  className={`text-xs font-medium px-2 py-0.5 rounded-full shrink-0 ${roleBadgeClass(inv.role_name)}`}
                >
